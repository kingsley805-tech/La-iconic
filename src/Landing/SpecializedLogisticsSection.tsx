            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    <h2 className="text-4xl lg:text-5xl font-bold text-black mb-6 leading-tight">
                        ...
                        <span className="bg-gradient-to-r from-[#f5092d] to-[#f5092d] bg-clip-text text-transparent">
                            Unforgettable Tours
                        </span>
                    </h2>
                        ...
                        >
                            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 h-full w-full flex flex-col relative overflow-hidden">
                                ...
                                <div className="p-8 pb-4 flex justify-center">
                                    <motion.div
                                        className="w-20 h-20 rounded-2xl flex items-center justify-center bg-gradient-to-br from-[#f5092d] to-[#f5092d] shadow-lg"
                                        animate={{
                                            y: [0, -5, 0],
                                            rotate: [0, 2, -2, 0],
                                            transition: {
