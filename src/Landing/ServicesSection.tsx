...
>
  <div className="max-w-3xl text-left">
    <h2 className="text-4xl lg:text-5xl font-bold text-gray-800 mb-6 leading-tight">
      Discover Your LA 
      <span className="bg-gradient-to-r from-[#FEFE02] to-[#FDF756] bg-clip-text text-transparent"> Journey</span>
    </h2>
          ...
          {tours.map((tour, index) => (
            ...
            >
              ...
              <motion.div 
                ...
                style={{
                  background: 'linear-gradient(135deg, #FDF756 0%, #FEFE02 100%)',
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-2 group-hover:text-[#FDF756] transition-colors duration-300">
                {tour.title}
              </h3>
